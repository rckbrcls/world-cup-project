...
export function HomeCommandCenter({
  ...
  return (
    ...
    >
      ...
      <CommandList>
        {!isCatalogLoading && !isCatalogRefreshing ? (
        ...
        <CommandSeparator />
        {isCatalogLoading && !hasIndexedData ? (
          <CommandMenuSkeleton className="pt-2" />
        ) : (
          <LoadingOverlay
            loading={isCatalogRefreshing}
            className="rounded-lg"
            skeleton={<CommandMenuSkeleton className="pt-2" />}
          >
            <div>
